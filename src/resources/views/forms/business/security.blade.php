...
<body>
 ...
 <form action="../../js/bus-security.php" method="post" name="security" id="security" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Security Liability Insurance</h1>
  ...
  <!--   4  -->
   <div class="form form5"> 
    <select id="title" name="title">
     ...
     <!--   5 -->
   <div class="form form5">
    <input type="text" name="reaid" id="reaid" value="" required autocomplete="off">
    <label for="name" class="label-name">
