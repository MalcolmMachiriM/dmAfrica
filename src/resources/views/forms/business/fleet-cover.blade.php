...
<div id="loading-overlay">
 ...
 <form action="{{ route('fleet-cover-insurance.store') }}" method="post" name="fleet" id="fleet" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Fleet Cover</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('fleet-cover-insurance.store') }}" method="POST">
    @csrf
  <!--   1  -->
