...
<div id="loading-overlay">
 ...
 <form action="{{ route('professional-insurance.store') }}" method="post" name="professional" id="professional" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Professional Indemity Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('professional-insurance.store') }}" method="POST">
    @csrf
  <!--   1  -->
