...
<div class="headwrap"> <a href="../index.htm" class="logo"><img src="../img/logo.png" border="0"></a> 
  ...
  <ul class="menu"> 
    ...
    <li><a href="../login/index.htm">My Policy</a></li> 
...
<div class="warpper bannertp careers"> 
  <h1>DM AFRICA HOLDINGS <br/><span>Contact</span></h1> 
  <button class="bnrbtn">Get A Quote</button> 
</div> 
<!-- end banner --> 
<!-- section --> 
<section> 
<h1 class="hugelwlft">Contact Us</h1>
<h2>If you require assistance or simply want to contact with a helpful member of the DMAfrica team, get in touch with any of the departments listed below.</br></br>Keep in mind that you can reach our Client Care Department by calling</h2>
<h1 class="hugelwlft">032 866 0362.</h1><h2>
The DMAfrica portal allows you to make changes to your insurance coverage, file a claim, and get more information.</h2>

<div class="wire">
    <div class="lagbtn"><a href="#">Login</a></div> 

</div>


<div class="wire divct gran"> 
  ...
  <button class="whtredbtn"> 
  <a href="#">Scams And Fraud Reporting</a> 
  </button> 
  <button class="whtredbtn"> 
  <a href="#">Compliance And FIAS</a> 
  </button> 
</div>
...
<div class="img-card iCard-style3">
                        <div class="card-content">
                            <div class="card-image">
                                ...
                                <img src="../img/contact-claim.png">
                            </div>
                            
                            <div class="card-text">
                                  <h1 class="blktxt">Claims</h1>
                       <h1 class="redtxtbrt">032 866 0362</h1>
                            </div>
      ...
      <a href="#"><i class="fab fa-youtube google-bg"></i></a>
      <a href="#"><i class="fab fa-linkedin google-bg"></i></a>
...
<div class="img-card iCard-style3">
                        <div class="card-content">
                            <div class="card-image">
                                ...
                                <img src="../img/contact-sales.png">
                            </div>
                            
                            <div class="card-text">
                                  <h1 class="blktxt">Sales</h1>
                       <h1 class="redtxtbrt">032 866 0362</h1>
                            </div>
...
<div class="img-card iCard-style3">
                        <div class="card-content">
                            <div class="card-image">
                                ...
                                <img src="../img/contact-care.png">
                            </div>
                            
                            <div class="card-text">
                                  <h1 class="blktxt">Client Care</h1>
                       <h1 class="redtxtbrt">032 866 0362</h1>
                            </div>
