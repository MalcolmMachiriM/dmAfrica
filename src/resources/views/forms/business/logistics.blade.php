...
<body>
 ...
 <form action="../../js/bus-logistics.php" method="post" name="logistics" id="logistics" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Logistics Insurance</h1>
