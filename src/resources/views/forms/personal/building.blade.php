...
<div id="loading-overlay">
 ...
 <form action="{{ route('building-insurance.store') }}" method="post" name="building" id="building" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Building Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('building-insurance.store') }}" method="POST">
 @csrf
  <!--   1  -->
