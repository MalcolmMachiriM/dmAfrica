...
<body>
 ...
 <form action="../../js/bus-cyber.php" method="post" name="cyber" id="cyber" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Cyber Security</h1>
