...
<div id="loading-overlay">
 ...
 <form action="{{ route('car-waranty-insurance.store') }}" method="post" name="car-warranty" id="car-warranty" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Car Warranty Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('car-waranty-insurance.store') }}" method="POST">
    @csrf
  <!--   1  -->
 ...
 <div class="form form5"> 
  ...
  <!--   3  -->
 <div class="form form5"> 
    <select id="mstatus" name="marital_status">
...
<!--   9 -->
 <div class="form form5">
    <input type="type" name="vehicle_make" id="vehicle_make" value="" required autocomplete="off">
    <label for="name" class="label-name">
