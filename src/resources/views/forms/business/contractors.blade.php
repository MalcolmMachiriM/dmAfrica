...
<div id="loading-overlay">
 ...
 <form action="{{ route('contractors-insurance.store') }}" method="post" name="contractors" id="contractors" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Contractors All Risk Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('contractors-insurance.store') }}" method="POST">
    @csrf
  <!--   1  -->
