...
<div id="loading-overlay">
 ...
 <form action="{{ route('construction-insurance.store') }}" method="post" name="construction" id="construction" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Construction Guarantee</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('construction-insurance.store') }}" method="POST">
    @csrf
  <!--   1  -->
