...
<div id="loading-overlay">
 ...
 <form action="{{ route('pet-insurance.store') }}" method="post" name="pet" id="pet" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Pet Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('pet-insurance.store') }}" method="POST">
    @csrf
