...
@endif -->
<!-- Include the loading animation -->
<div id="loading-overlay">
    <div class="loader"></div>
</div>


 <form action="{{ route('motor-insurance.store') }}" method="post" name="motor" id="motor" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event);"> 

  <h1>Quote For Motor Vehicle Insurance</h1>
...
<h3>Savings Are Just A Click Quote Away.</h3>
  ...
  <div class="form form5">
    ...
    <label for="full_name" class="label-name">
 ...
 <div class="form form5"> 
    ...
    <select id="gender" name="gender">
                ...
                </select> <label for="gender" class="label-name">
 ...
 <div class="form form5"> 
    <select id="marital_status" name="marital_status">
                ...
                </select> <label for="marital_status" class="label-name">
  ...
  <!--   4  -->
   ...
   <div class="form form5">
    ...
    <label for="rsa_id" class="label-name">
...
<!--   6 -->
 <div class="form form5">
    <input type="text" name="license_code" id="license_code" value="" required autocomplete="off">
    <label for="license_code" class="label-name">
      <span class="content-name">License Code</span>
    </label>
  </div>

<!--   7 -->
 <div class="form form5">
    <input type="text" name="home_address" id="home_address" value="" required autocomplete="off">
    <label for="home_address" class="label-name">
...
<!--   8 -->
 <div class="form form5">
    <input type="text" name="vehicle_year" id="vehicle_year" value="" required autocomplete="off">
    <label for="vehicle_year" class="label-name">
      <span class="content-name">Vehicle Year</span>
    </label>
  </div>

<!--   9 -->
 <div class="form form5">
    <input type="type" name="vehicle_make" id="vmake" value="" required autocomplete="off">
    <label for="vehicle_make" class="label-name">
      <span class="content-name">Vehicle Make</span>
    </label>
  </div>

<!--   10 -->
 <div class="form form5">
    <input type="type" name="vehicle_model" id="vehicle_model" value="" required autocomplete="off">
    <label for="vehicle_model" class="label-name">
...
<!--   11 -->
 <div class="form form5">
    <input type="type" name="email" id="email" value="" required autocomplete="off">
...
<!--   12 -->
 <div class="form form5">
    <input type="type" name="contact" id="contact" value="" required autocomplete="off">
...
<p>DISCLAIMER: DM Africa is a registered financial services provider. This message, including attachements, are intended for the named addressee only and may contain confidential or proprietary information. Access to its contents and any review, retransmission, dissemination, copy, disclosure of all or any part of this message and its contents, or taking, or omitting to take, any other action in reliance upon the content by anyone other than the intended recipient is unauthorized. If you are not the intended recipient, notify the sender immediately and delete the message from your computer systems. Views and opinions expressed in this message are those of the sender and do not necessarily represent the views and opinions of Dm Africa nor do they constitute any commitment by or obligation on agreements concluded by means of electronic communincations by any of its employees or intermediaries, unless so permitted in writing by a duly authorised representative Dm Africa cannot guarantee that this message is secure or free of errors or viruses, nor does it accept any responsibility for the contents of this message, its late delivery, non-delivery or incorrect delivery for whatever reason or its effect on.</p>
              ...
              <div class="wire"><input type="submit" name="button" id="button" class="sendbtn" value="Submit">
               ...
               <button href="../../../contact.htm" type="button">Let Us Help You</button></div>
...
<!-- <style>
  /* Overlay to cover the page while loading */
#loading-overlay {
    position: fixed;
    top: 0;
    left: 0;
