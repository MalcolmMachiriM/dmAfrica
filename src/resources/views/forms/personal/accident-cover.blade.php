...
<div id="loading-overlay">
 ...
 <form action="{{ route('accident-cover-insurance.store') }}" method="post" name="accident" id="accident" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum'); submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Accident Cover Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('accident-cover-insurance.store') }}" method="POST">
    @csrf
