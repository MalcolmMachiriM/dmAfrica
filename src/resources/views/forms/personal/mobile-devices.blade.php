...
<div id="loading-overlay">
 ...
 <form action="{{ route('mobile-devices-insurance.store') }}" method="post" name="mobile" id="mobile" onsubmit="MM_validateForm('email','','RisEmail','people','','NisNum');submitForm(event); return document.MM_returnValue"> 

  <h1>Quote For Mobile Device Insurance</h1>
...
@if (session('success'))
        ...
        @endif
        <form action="{{ route('mobile-devices-insurance.store') }}" method="POST">
        @csrf
  <!--   1  -->
 ...
 <div class="form form3">
   ...
   <div class="form form3"> 
    <select id="idtype" name="idtype">
      ...
      <span class="content-name select">Identity Type</span>
    </label>
  </div>
